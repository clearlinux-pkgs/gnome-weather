...
Source0  : https://download.gnome.org/sources/gnome-weather/48/gnome-weather-48.0.tar.xz
...
%prep
%setup -q -n gnome-weather-48.0
cd %{_builddir}/gnome-weather-48.0
pushd ..
cp -a gnome-weather-48.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742589740
...
/usr/share/icons/hicolor/scalable/status/checkmark-symbolic.svg
