...
Source0  : https://download.gnome.org/sources/gnome-weather/43/gnome-weather-43.0.tar.xz
...
%prep
%setup -q -n gnome-weather-43.0
cd %{_builddir}/gnome-weather-43.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663953274
