...
Source0  : https://download.gnome.org/sources/gnome-weather/3.36/gnome-weather-3.36.1.tar.xz
...
%prep
%setup -q -n gnome-weather-3.36.1
cd %{_builddir}/gnome-weather-3.36.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588038208
...
cp %{_builddir}/gnome-weather-3.36.1/COPYING.md %{buildroot}/usr/share/package-licenses/gnome-weather/323be5b629b728c08f2c9a998725c4584f97fb18
