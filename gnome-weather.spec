...
Source0  : https://download.gnome.org/sources/gnome-weather/47/gnome-weather-47.0.tar.xz
...
%prep
%setup -q -n gnome-weather-47.0
cd %{_builddir}/gnome-weather-47.0
pushd ..
cp -a gnome-weather-47.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726768684
