...
Source0  : https://download.gnome.org/sources/gnome-weather/3.32/gnome-weather-3.32.0.tar.xz
...
%prep
%setup -q -n gnome-weather-3.32.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1552352778
...
%files locales -f gnome-weather.lang
%defattr(-,root,root,-)
