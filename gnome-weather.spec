...
Version  : 45.0
Release  : 26
URL      : https://download.gnome.org/sources/gnome-weather/45/gnome-weather-45.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-weather/45/gnome-weather-45.0.tar.xz
...
%prep
%setup -q -n gnome-weather-45.0
cd %{_builddir}/gnome-weather-45.0
pushd ..
cp -a gnome-weather-45.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695686161
