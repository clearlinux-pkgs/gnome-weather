...
Source0  : https://download.gnome.org/sources/gnome-weather/42/gnome-weather-42.0.tar.xz
...
%prep
%setup -q -n gnome-weather-42.0
cd %{_builddir}/gnome-weather-42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647886719
...
cp %{_builddir}/gnome-weather-42.0/COPYING.md %{buildroot}/usr/share/package-licenses/gnome-weather/323be5b629b728c08f2c9a998725c4584f97fb18
